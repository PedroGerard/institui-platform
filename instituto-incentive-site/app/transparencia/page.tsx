          ...
          <div className="space-y-5 text-base leading-8 text-[var(--brand-muted)]">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                ...
                className="inline-flex w-fit items-center gap-2 rounded-lg border border-[var(--brand-border-strong)] bg-white px-5 py-3 text-sm font-semibold text-[var(--brand-text)] transition hover:border-[var(--brand-teal)] hover:text-[var(--brand-teal)]"
              >
